package com.androidproject.comarkdown.filesystem.view;
...
import com.androidproject.comarkdown.filesystem.utils.AlertUtil;
...
public class RenameFileDialog {
    ...
    public void show() {
        ...
        btnCancel = (Button) dialog.getWindow().findViewById(
